...
func (p *rangeQuery) Init() {
	...
	rules = [...]func() bool{
		...
		/* 14 funcargs <- <((rangeexpr Action11 ';' funcargs) / (rangeexpr Action12))> */
		func() bool {
